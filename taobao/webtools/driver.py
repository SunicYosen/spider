...
class Driver:
    ...
    def init_dirver(self, headless=True):
        if(headless):
            self.add_options('headless')
        
        self.add_options("--disable-blink-features=AutomationControlled")
        self.add_options("--user-data-dir=/home/sun/.config/google-chrome/Default")
